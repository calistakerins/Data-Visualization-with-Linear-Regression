...
```{r}
library(tidyverse)
life_expectancies_by_region <- read.csv("Life-Expectancy-Dataset.csv")
happiness_scores_by_region <- read.csv("Happiness-Dataset.csv")
```
...
-   Use linear regression to model the relationship between your variables.
